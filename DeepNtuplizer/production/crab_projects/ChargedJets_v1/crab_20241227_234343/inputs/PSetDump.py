...
process.ak4PFStdJets = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.patJetFlavourAssociationAK4PFStd = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartons","bHadrons"),
    cHadrons = cms.InputTag("patJetPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak4PFStdJets"),
    leptons = cms.InputTag("patJetPartons","leptons"),
    partons = cms.InputTag("patJetPartons","physicsPartons"),
    rParam = cms.double(0.4)
)
...
process.patJetFlavourAssociationLegacyAK4PFStd = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAK4PFStd")
)
...
process.patJetGenJetMatchAK4PFStd = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak4GenJetsRecluster"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
...
process.patJetPartonAssociationLegacyAK4PFStd = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak4PFStdJets"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonMatchAK4PFStd = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetsAK4PFStd = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAK4PFStd"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAK4PFStd"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addEfficiencies = cms.bool(False),
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchAK4PFStd"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAK4PFStd"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag("patJetCorrFactors"),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak4PFStdJets"),
    mightGet = cms.optional.untracked.vstring,
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
...
process.updatedPatJetsAK4PFChg = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(False),
    addTagInfos = cms.bool(False),
...
process.updatedPatJetsAK4PFStd = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(False),
    addTagInfos = cms.bool(False),
    discriminatorSources = cms.VInputTag(),
    jetCorrFactorsSource = cms.VInputTag("updatedPatJetCorrFactors"),
    jetSource = cms.InputTag("selectedPatJetsAK4PFStd"),
    mightGet = cms.optional.untracked.vstring,
    printWarning = cms.bool(True),
    sort = cms.bool(True),
    tagInfoSources = cms.VInputTag(),
...
process.selectedPatJetsAK4PFStd = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsAK4PFStd")
)


process.selectedUpdatedPatJetsAK4PFChg = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("updatedPatJetsAK4PFChg")
)


process.selectedUpdatedPatJetsAK4PFStd = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("updatedPatJetsAK4PFStd")
)


process.genbanalizer = cms.EDAnalyzer("GenBNtuplizer",
    genparts = cms.InputTag("prunedGenParticles"),
    jets = cms.InputTag("selectedUpdatedPatJetsAK4PFStd"),
    pfChargedJets = cms.InputTag("selectedUpdatedPatJetsAK4PFChg"),
...
process.patAlgosToolsTask = cms.Task(process.ak4PFChgJets, process.ak4PFJetsPuppiRecluster, process.ak4PFStdJets, process.packedPFCandidatesChg, process.patJetFlavourAssociationAK4PFChg, process.patJetFlavourAssociationAK4PFStd, process.patJetFlavourAssociationLegacyAK4PFChg, process.patJetFlavourAssociationLegacyAK4PFStd, process.patJetGenJetMatchAK4PFChg, process.patJetGenJetMatchAK4PFStd, process.patJetPartonAssociationLegacyAK4PFChg, process.patJetPartonAssociationLegacyAK4PFStd, process.patJetPartonMatchAK4PFChg, process.patJetPartonMatchAK4PFStd, process.patJetPartons, process.patJetPartonsLegacy, process.patJetsAK4PFChg, process.patJetsAK4PFStd, process.puppi, process.puppiNoLep, process.selectedPatJetsAK4PFChg, process.selectedPatJetsAK4PFStd, process.selectedUpdatedPatJetsAK4PFChg, process.selectedUpdatedPatJetsAK4PFStd, process.updatedPatJetsAK4PFChg, process.updatedPatJetsAK4PFStd)
