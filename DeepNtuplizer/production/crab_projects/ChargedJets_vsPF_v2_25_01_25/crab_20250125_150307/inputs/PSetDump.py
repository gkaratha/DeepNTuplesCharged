...
process.ak4PFReclusterJets = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.patJetFlavourAssociationAK4PFRecluster = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartons","bHadrons"),
    cHadrons = cms.InputTag("patJetPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak4PFReclusterJets"),
    leptons = cms.InputTag("patJetPartons","leptons"),
    partons = cms.InputTag("patJetPartons","physicsPartons"),
    rParam = cms.double(0.4)
)
...
process.patJetFlavourAssociationLegacyAK4PFRecluster = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAK4PFRecluster")
)
...
process.patJetGenJetMatchAK4PFRecluster = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak4GenJetsRecluster"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
    ...
    resolveAmbiguities = cms.bool(True),
    resolveByMatchQuality = cms.bool(False),
    src = cms.InputTag("ak4PFReclusterJets")
)
...
process.patJetPartonAssociationLegacyAK4PFRecluster = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak4PFReclusterJets"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonMatchAK4PFRecluster = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetsAK4PFRecluster = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAK4PFRecluster"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAK4PFRecluster"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addEfficiencies = cms.bool(False),
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchAK4PFRecluster"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAK4PFRecluster"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag("patJetCorrFactors"),
    jetIDMap = cms.InputTag("ak4JetID"),
...
process.updatedPatJetsAK4PFR = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(False),
    addTagInfos = cms.bool(False),
...
process.selectedPatJetsAK4PFRecluster = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsAK4PFRecluster")
)
...
process.selectedUpdatedPatJetsAK4PFR = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("updatedPatJetsAK4PFR")
)


process.genbanalizer = cms.EDAnalyzer("GenBNtuplizer",
    genparts = cms.InputTag("prunedGenParticles"),
    jets = cms.InputTag("selectedUpdatedPatJetsAK4PFR"),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('outputPFCvsPFRecluster_0.root')
)
...
process.patAlgosToolsTask = cms.Task(process.ak4PFChgJets, process.ak4PFReclusterJets, process.packedPFCandidatesChg, process.patJetFlavourAssociationAK4PFChg, process.patJetFlavourAssociationAK4PFRecluster, process.patJetFlavourAssociationLegacyAK4PFChg, process.patJetFlavourAssociationLegacyAK4PFRecluster, process.patJetGenJetMatchAK4PFChg, process.patJetGenJetMatchAK4PFRecluster, process.patJetPartonAssociationLegacyAK4PFChg, process.patJetPartonAssociationLegacyAK4PFRecluster, process.patJetPartonMatchAK4PFChg, process.patJetPartonMatchAK4PFRecluster, process.patJetPartons, process.patJetPartonsLegacy, process.patJetsAK4PFChg, process.patJetsAK4PFRecluster, process.puppi, process.puppiNoLep, process.selectedPatJetsAK4PFChg, process.selectedPatJetsAK4PFRecluster, process.selectedUpdatedPatJetsAK4PFChgR, process.selectedUpdatedPatJetsAK4PFR, process.updatedPatJetsAK4PFChgR, process.updatedPatJetsAK4PFR)
