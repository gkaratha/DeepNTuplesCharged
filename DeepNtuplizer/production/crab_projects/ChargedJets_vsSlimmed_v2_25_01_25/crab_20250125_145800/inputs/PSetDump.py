...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('outputPFCvsSlimmed_0.root')
)
...
process.patAlgosToolsTask = cms.Task(process.ak4PFChgJets, process.packedPFCandidatesChg, process.patJetFlavourAssociationAK4PFChg, process.patJetFlavourAssociationLegacyAK4PFChg, process.patJetGenJetMatchAK4PFChg, process.patJetPartonAssociationLegacyAK4PFChg, process.patJetPartonMatchAK4PFChg, process.patJetPartons, process.patJetPartonsLegacy, process.patJetsAK4PFChg, process.puppi, process.puppiNoLep, process.selectedPatJetsAK4PFChg, process.selectedUpdatedPatJetsAK4PFChgR, process.updatedPatJetsAK4PFChgR)
